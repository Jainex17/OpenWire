...
export const Content1 = ({ activeDevice }: SectionProps) => {
    return (
...
export const Content2 = ({ activeDevice }: SectionProps) => {
    return (
                ...
                <div className={`grid gap-12 ${activeDevice === "mobile" ? "grid-cols-1" : "grid-cols-2"}`}>
                    {[1, 2].map((i) => (
                        <div key={i} className="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <div className="p-8">
                                <div className="text-sm font-semibold text-blue-600 mb-2">Tutorial</div>
                                <h3 className="text-xl font-bold text-gray-900 mb-4">Getting started with the new editor</h3>
                                <p className="text-gray-600 mb-6">Learn how to make the most out of our new features in this comprehensive guide.</p>
                                <a href="#" className="font-semibold text-gray-900 hover:text-blue-600">Read Article →</a>
                            </div>
                        </div>
                    ))}
                </div>
...
export const Content3 = ({ activeDevice }: SectionProps) => {
    return (
        <div className="w-full px-8 py-24 bg-white text-center">
            <div className="max-w-4xl mx-auto">
                <h2 className="text-sm font-bold text-blue-600 uppercase tracking-widest mb-4">Spotlight</h2>
                <h3 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8">Master your workflow</h3>
                <p className="text-xl text-gray-500 mb-12 max-w-2xl mx-auto">
                    Our tools are designed to work together, so you can focus on building what matters most.
                </p>
                <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-100 bg-gray-50 aspect-video flex items-center justify-center">
                    <span className="text-gray-400 font-medium">Product Demo Video</span>
