...
import { ArrowDown, ArrowDownNarrowWide, ChevronDown, FigmaIcon, MoonIcon, SunIcon } from "lucide-react";
  ...
  return (
    <div className="fixed top-4 right-4 flex items-center gap-2 z-50">
      ...
      <DropdownMenu modal={false}>
        ...
        <DropdownMenuContent side="bottom" align="end" className="bg-primary-foreground text-secondary-foreground border-none">
